      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
            Security Enthusiast with 6+ years of expertise in VAPT, Red Teaming, Secure Code Review, 
            and Threat Modeling across Mobile, Web Apps, APIs, and Cloud. Experienced in Bug Bounty 
            management, compliance (ISO 27001), CIS Benchmarking and security automation.
          </p>
